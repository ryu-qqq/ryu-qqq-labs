...
| `lab/hibernate-internals` | Hibernate 내부 동작 | 1차 캐시, Dirty Checking, Flush 타이밍, 프록시, N+1 해결, IDENTITY 배치 함정, 낙관적 락, 2차 캐시 | [hibernate-internals-lab.md](docs/hibernate-internals-lab.md) |
